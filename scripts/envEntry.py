...
def run_playground():
    ...
    policy_config.D_q_episodes_num = 20
    policy_config.p_episodes_num = 100
    policy_config.q_episodes_num = 40
    ...
    # irl_config.bound_r = (-1.0, 1.0)
    # irl_config.evalT = 1
    # irl_config.b_load = False
    # irl_config.save_flag = '_MaxEntIRL_reward'

    # policy_config = PolicyConfig()
    # policy_config.D_p_episodes_num = 0
    # policy_config.D_q_episodes_num = 20
    # policy_config.p_episodes_num = 100
    # policy_config.q_episodes_num = 40
    # policy_config.e_episodes_num = 3
